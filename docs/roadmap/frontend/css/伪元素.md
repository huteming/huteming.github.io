...
<iframe
  ...
  scrolling='no'
  title='first-letter'
  src='https://codepen.io/huteming/embed/JjVagXE?default-tab=result&editable=true&theme-id=light'
  frameborder='no'
  loading='lazy'
  allowtransparency='true'
  allowfullscreen='true'
>
  See the Pen <a href='https://codepen.io/huteming/pen/JjVagXE'>first-letter</a> by huteming (
